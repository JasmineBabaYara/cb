...
class ActionProvider {
  ...
  async greet() {
    ...
    // const greetingMessage = this.createChatBotMessage(`Hi, ${result['Hello']}.`);
    // this.updateChatbotState(greetingMessage);
  }

  didNotUnderstand() {
    // const greetingMessage = this.createChatBotMessage("Sorry I couldn't understand what you typed.");
    const greetingMessage = this.createChatBotMessage("Please Select from the available options.");
    this.updateChatbotState(greetingMessage);
  }
