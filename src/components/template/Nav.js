  ...
  return (
    <>
      <div className="nav-wrapper">
        ...
        <Link to="/settings"><button className="settings-btn"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
