    ...
    return (
      <>
        <div className="chat-with-ai-wrapper">
          <Link to="/chatbot">
            <button class="chat-with-ai-btn">
              Chat With Our Intelligent AI Chatbot kit
            </button>
          </Link>
        </div>
          ...
          <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body>
                ...
                <p />
                <p className="bold-p-tag">Level</p>
                <p> Intermediate</p>
                <p className="bold-p-tag">Employment type</p>
                <p>Full-time</p>
                <p className="bold-p-tag">Job function</p>
                <p>Engineering and Information Technology</p>
                <p className="bold-p-tag">Industries</p>
                <p>Information Services and Internet Publishing</p>
              </Accordion.Body>
            </Accordion.Item>
